-- Prevent authenticated callers from creating unbounded api_rate_limits rows by
-- supplying arbitrary scope strings to the public rate-limit RPC. Application
-- routes use a small, fixed list of per-user cost-protection scopes.
