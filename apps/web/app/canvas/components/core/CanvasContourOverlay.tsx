      ...
      <defs>
        <pattern id="contour-pattern" width="1200" height="800" patternUnits="userSpaceOnUse">
          ...
          <path
            ...
            fill="none"
            stroke="var(--canvas-theme-contour)"
            strokeWidth="0.75"
            strokeDasharray="4 4"
          />
          <path
          ...
          <circle cx="1050" cy="650" r="120" fill="none" stroke="var(--canvas-theme-contour)" strokeWidth="0.75" strokeDasharray="3 3" />
          <circle cx="1050" cy="650" r="80" fill="none" stroke="var(--canvas-theme-contour)" strokeWidth="0.5" />
          <circle cx="1050" cy="650" r="40" fill="none" stroke="var(--canvas-theme-contour)" strokeWidth="0.5" />

          <circle cx="150" cy="150" r="90" fill="none" stroke="var(--canvas-theme-contour)" strokeWidth="0.5" strokeDasharray="2 4" />
          <circle cx="150" cy="150" r="50" fill="none" stroke="var(--canvas-theme-contour)" strokeWidth="0.5" />
        </pattern>
      </defs>
