...
const THEME_PALETTES: Record<CanvasTheme, ThemePalette> = {
  light: {
    ...
    "connection-text": "#9B7CFF", "connection-text-soft": "rgba(155, 124, 255, 0.14)",
    "connection-image": "#5E8BFF", "connection-image-soft": "rgba(94, 139, 255, 0.14)",
  ...
  dark: {
    ...
    "connection-text": "#B79BFF", "connection-text-soft": "rgba(183, 155, 255, 0.16)",
    "connection-image": "#7DA0FF", "connection-image-soft": "rgba(125, 160, 255, 0.16)",
  ...
  "green-light": {
    ...
    "connection-text": "#8E7CF4", "connection-text-soft": "rgba(142, 124, 244, 0.14)",
    "connection-image": "#4E84F7", "connection-image-soft": "rgba(78, 132, 247, 0.14)",
  ...
  "green-dark": {
    ...
    "connection-text": "#AF97FF", "connection-text-soft": "rgba(175, 151, 255, 0.17)",
    "connection-image": "#7D9FFF", "connection-image-soft": "rgba(125, 159, 255, 0.17)",
