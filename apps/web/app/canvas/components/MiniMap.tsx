  ...
  return (
    <div className="absolute bottom-7 left-7 z-40 w-52 rounded-3xl border border-[#E5E7EB] bg-white/95 p-3 shadow-2xl shadow-black/10 backdrop-blur">
      ...
      <div className="mt-3 flex items-center justify-between">
        <span className="text-xs font-black text-[#667085]">31%</span>
        <div className="flex gap-1">
          {[Layers, Lock, Maximize].map((Icon, index) => (
            <button key={index} className="grid h-7 w-7 place-items-center rounded-lg bg-[#F7F8FA] text-[#667085]">
